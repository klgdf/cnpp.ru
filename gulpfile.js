...
let
  select_settings = 0, // select current settings
  current_projects = [
    // {
    //   folder: 'example',
    ...
    //   fonts: false, // ttf2woff2 or auto
    // },
    {
      folder: 'source',
      html: false, // html or pug
      html_folder: 'html', // 'html' or 'wordpress'
      scss: false, // scss or sass
      js: false, // main.js or common.js and vendors.js,
      common_list: true, // list or auto
      vendors_list: true, // list or auto
      fonts: false, // ttf2woff2 or auto
  ...
  settings = current_projects[select_settings];

let project_folder = 'build';
let source_folder = settings.folder;
...
let path = {
  ...
  watch: {
    ...
    html: source_folder + '/' + settings.html_folder + '/**/*.{html,php}',
...
//! Хочу чтобы png не попадали, если webp включено в settings.
function images() {
